...
export const features = () => {
  ...
  const onAddContactClick = useCallback(() => {
    setFormDataDefaults(newFeatures);
  ...
  const onSaveClick = useCallback(async() => {
    try {
      ...
      notify(
        {
          message: 'Failed to save New Features Article. Please try again later.',
          position: { at: 'bottom center', my: 'bottom center' },
        },
        'error'
      );
  ...
  return (
    <div className='view crm-contact-list'>
      <div className='view-wrapper view-wrapper-contact-list list-page'>
        ...
        >
          ...
          <Toolbar>
            <Item location='before'>
              <div className='grid-header'>New Features Article</div>
            </Item>
        ...
        <FormPopup
          title='Add/Edit New Features Article'
