...
export const news = () => {
  ...
  const onSaveClick = useCallback(async() => {
    try {
      ...
      notify(
        {
          message: 'Failed to save news Article. Please try again later.',
          position: { at: 'bottom center', my: 'bottom center' },
        },
        'error'
      );
        ...
        >
          ...
          <Toolbar>
            <Item location='before'>
              <div className='grid-header'>News Article</div>
            </Item>
